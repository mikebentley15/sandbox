...
int main(int argCount, char* argList[]) {
  ros::init(argCount, argList, "points_and_lines");
  ros::NodeHandle n;
  ...
  while (ros::ok()) {
    ...
    // POINTS markers use x and y xcale for width/height respectively
    points.scale.x = 0.2;
    points.scale.y = 0.2;
