...
var monthWidth = Math.max(400, (innerRadius * 2) - 250);
...
var e_fill= d3.scaleOrdinal()
              .range(["#00AC6B","#20815D","#007046","#35D699","#60D6A9"]);
var i_fill= d3.scaleOrdinal()
              .range(["#EF002A","#B32D45","#9B001C","#F73E5F","#F76F87"]);
