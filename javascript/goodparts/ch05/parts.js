// We cancompose objects out of sets of parts

// Let's add simple event processing to any object, adding on(), fire() and a
...
var eventuality = function (that) {
  ...
  that.fire = function (event) {
    ...
    // the name of the event or an object containing a type property containing
    // the name of the event.  Handlers registered by the 'on' method that
    // match the event name will be invoked.
...
// We could now provide eventuality() to any object to bestow it with these
// methods and functionality.  Alternatively, we could pass it the that pointer
// inside of a functional-style constructor, bestowing the new object type with
// this functionality.
